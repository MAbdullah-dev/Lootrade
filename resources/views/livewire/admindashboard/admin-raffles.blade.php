<div style="flex: 1">
    <section class="admin-raffles">
        <div class="inner">
            ...
            <!-- Edit Raffle Modal -->
            <div wire:ignore.self class="modal fade" id="editRaffleModal" tabindex="-1" aria-labelledby="editRaffleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <div wire:ignore class="input-wrapper">
                                    ...
                                    <input type="text" id="date_range_edit" class="form-control" wire:model.defer="date_range"  placeholder="{{ $date_range ?? 'Select start and end date' }}"  readonly>
                                </div>
                                <h6 style="background-color: #fe3839; color: #ffffff; padding: 5px;" class="mt-2 w-100 fw-bold">Your Selected Date: <br> {{ $date_range }}</span>
                                @error('date_range') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="button" class="btn-custom" wire:click="updateRaffle({{ $raffle_id }})">Update Raffle</button>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        ...
                                        <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#editRaffleModal" wire:click="viewForEditRaffle({{ $raffle->id }})">
