<section class="support-section">
    ...
    <div class="ticket-list mt-3 w-75 mx-auto">
        <h5 class="mb-5">Tickets Initiated</h5>

        <input type="text" class="form-control mb-3 w-50" placeholder="Search Tickets..." wire:model.live="search">
