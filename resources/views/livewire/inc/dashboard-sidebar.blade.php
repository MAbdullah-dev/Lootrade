<aside>
    <div class="sidebar">
        <nav class="nav d-flex flex-column" role="navigation" aria-label="User Sidebar Navigation">
            <ul>
                <li class="nav-item">
                    <a class="d-flex align-items-center side-nav-icons {{ Route::currentRouteName() == 'profile' ? 'active' : '' }}"
                        href="{{ route('profile') }}" wire:navigate aria-label="Go to Profile"
                        @if (Route::currentRouteName() == 'profile') aria-current="page" @endif>
                        <i class="fas fa-user" aria-hidden="true"></i> <span>Profile</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="d-flex align-items-center side-nav-icons {{ Route::currentRouteName() == 'myTickets' ? 'active' : '' }}"
                        href="{{ route('myTickets') }}" wire:navigate aria-label="Go to My Tickets"
                ...
                <li class="nav-item">
                    <a class="d-flex align-items-center side-nav-icons {{ Route::currentRouteName() == 'support' ? 'active' : '' }}"
                        href="{{ route('support') }}" wire:navigate aria-label="Go to Support"
                        @if (Route::currentRouteName() == 'support') aria-current="page" @endif>
                        <i class="fas fa-headset" aria-hidden="true"></i> <span>Support</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="d-flex d-flex align-items-center side-nav-icons {{ Route::currentRouteName() == 'user.raffles' ? 'active' : '' }}"
                        href="{{ route('user.raffles') }}" wire:navigate aria-label="Go to Raffles"
                ...
                <li class="nav-item">
                    <a class="d-flex d-flex align-items-center side-nav-icons {{ Route::currentRouteName() == 'user.change.password' ? 'active' : '' }}"
                        href="{{ route('user.change.password') }}" wire:navigate aria-label="Go to Reset Password"
                ...
                <li class="nav-item" style="cursor: pointer">
                    <a class="d-flex align-items-center side-nav-icons" wire:click="logout()" role="button"
                        tabindex="0" aria-label="Logout from your account">
