    ...
    <section class="raffle-detail" aria-labelledby="raffle-title">
        <div class="container">
            <div class="inner py-5">
                        ...
                        <div class="raffle-info mt-4" role="region" aria-label="Raffle Information">
                            <div class="row">
                                <div class="col-6 mb-3">
                                    ...
                                    <strong>Start Date:</strong> <time datetime="{{ $raffle->start_date }}">{{ $raffle->start_date->format('M d, Y') }}</time>
                                </div>
                                <div class="col-6 mb-3">
                                    <i class="fas fa-calendar-check me-2" aria-hidden="true"></i>
                                    <strong>End Date:</strong> <time datetime="{{ $raffle->end_date }}">{{ $raffle->end_date->format('M d, Y') }}</time>
                                </div>
                                <div class="col-6 mb-3">
                            ...
                            <div class="tab-content" id="myTabsContent">
                                <div class="tab-pane fade show active" id="tab1" role="tabpanel"
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button class="btn-custom px-5 py-2" wire:click="startGame('solo')" aria-label="Play Ticket Tower Solo Mode">
                                            Play Solo
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="multi-tab">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button class="btn-custom px-5 py-2" wire:click="startGame('battle')" aria-label="Play Ticket Tower Battle Mode">
                                            Play Battle
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="users-wrapper" role="region" aria-label="List of Users Joined">
                    @foreach ($usersJoined ?? [] as $entry)
                        <div class="user-profile text-center" aria-label="User Profile">
                            <div>
