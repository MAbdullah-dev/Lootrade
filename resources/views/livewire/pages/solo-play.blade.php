        ...
        <div class="inner py-5">
            <div class="game-box" aria-labelledby="game-title">
                ...
                <div class="grid-wrapper d-flex flex-column justify-content-center align-items-center mt-4">
                    <button class="p-3 w-100 rounded mb-6 flex items-center justify-center my-3" aria-label="Game Info"
                        disabled>
                    ...
                    <div class="tile-grid w-100" role="grid" aria-label="Tile grid">
                        @foreach ($tiles as $tileIndex => $tile)
                            ...
                            <button role="gridcell"
                                ...
                                aria-pressed="{{ $isRevealed ? 'true' : 'false' }}" aria-label="{{ $tileLabel }}"
                                title="{{ $tileLabel }}" {{ $isRevealed || $isWrong ? 'disabled' : '' }}>
                    ...
                    <div class="playing-btn btn-custom w-100 mt-4" wire:click="startGame" data-sound="play"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content text-center p-4 rounded-4">
                    ...
                    <div class="d-flex justify-content-center gap-3 mt-4">
                        <button wire:click="secureEntries" class="btn btn-success px-4 py-2"
                            aria-label="Secure entries and stop playing">
                            ✅ Secure
                        </button>
                        <button wire:click="continueGame" class="btn btn-warning px-4 py-2"
